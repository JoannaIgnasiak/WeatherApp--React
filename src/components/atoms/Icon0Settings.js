...
const StyledSVG = styled.svg`
  ...
  transition: 0.5s;
  cursor: pointer;
  transform: rotate(${({ optionsOpen }) => (optionsOpen ? '0' : '90deg')});
  transition: transform 0.25s ease-in-out;
`;

class Icon0Settings extends Component {
  render() {
    const color = this.props.optionsOpen;

    return (
      <StyledSVG
        onClick={this.props.handleOptionOpen}
      ...
      >
        <path
          fill={`${color ? '#0e5580' : 'white'}`}
          d="M382.872,292.25l-32.625-18.834c1.042-5.666,1.75-11.458,1.75-17.416c0-5.979-0.708-11.792-1.792-17.458
